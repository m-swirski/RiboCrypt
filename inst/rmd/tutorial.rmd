...
4. Select a transcript: A transcript isoform of the given gene above, 
can be selected currently using:
...
in the plot panel)
5. Full annotation (display full annotation or just the tx you selected)
6. Summary top track (Add an additional plot track on top, summarizing all selecte libs)
7. Select Summary display type (same as frames display type above, but for the summary track)
8. Export format (When you hover the plot top right image button, and click export 
...
4. Select a transcript: A transcript isoform of the given gene above, 
can be selected currently using:
 - all (all transcripts from all genes (not just the one you selected!))
 - Transcript id (ENSEMBL)
5. Select libraries (multiple allowed)
6. Codon filter value (Minimum reads in ORF)
